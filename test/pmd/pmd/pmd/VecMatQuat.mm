...
void VecMatQuat::Vector3Add( Vector3 *pvec3Out, const Vector3 *pvec3Add1, const Vector3 *pvec3Add2 )
{
...
void VecMatQuat::Vector3Sub( Vector3 *pvec3Out, const Vector3 *pvec3Sub1, const Vector3 *pvec3Sub2 )
{
...
void VecMatQuat::Vector3MulAdd( Vector3 *pvec3Out, const Vector3 *pvec3Add1, const Vector3 *pvec3Add2, float fRate )
{
...
void VecMatQuat::Vector3Normalize( Vector3 *pvec3Out, const Vector3 *pvec3Src )
{
...
float VecMatQuat::Vector3DotProduct( const Vector3 *pvec3Src1, const Vector3 *pvec3Src2 )
{
	return (pvec3Src1->x * pvec3Src2->x + pvec3Src1->y * pvec3Src2->y + pvec3Src1->z * pvec3Src2->z);
}

void VecMatQuat::Vector3CrossProduct( Vector3 *pvec3Out, const Vector3 *pvec3Src1, const Vector3 *pvec3Src2 )
{
...
void VecMatQuat::Vector3Lerp( Vector3 *pvec3Out, const Vector3 *pvec3Src1, const Vector3 *pvec3Src2, float fLerpValue )
{
...
void VecMatQuat::Vector3Transform( Vector3 *pvec3Out, const Vector3 *pVec3In, const Matrix matTransform )
{
	Vector3	vec3Temp;
...
void VecMatQuat::Vector3Rotate( Vector3 *pvec3Out, const Vector3 *pVec3In, const Matrix matRotate )
{
	Vector3	vec3Temp;
...
void VecMatQuat::MatrixIdentity( Matrix matOut )
{
...
void VecMatQuat::MatrixRotationX( Matrix matOut, float fAngle )
{
	float	c = cosf( fAngle );
	float	s = sinf( fAngle );
...
void VecMatQuat::MatrixMultiply( Matrix matOut, const Matrix matSrc1, const Matrix matSrc2 )
{
	Matrix	matTemp;
	int		i;
...
void VecMatQuat::MatrixInverse( Matrix matOut, const Matrix matSrc )
{
	Matrix	matTemp;
...
void VecMatQuat::MatrixLerp( Matrix matOut, Matrix matSrc1, Matrix matSrc2, float fLerpValue )
{
...
void VecMatQuat::QuaternionCreateAxis( Vector4 *pvec4Out, const Vector3 *pvec3Axis, float fRotAngle )
{
...
void VecMatQuat::QuaternionCreateEuler( Vector4 *pvec4Out, const Vector3 *pvec3EulerAngle )
{
...
void VecMatQuat::QuaternionNormalize( Vector4 *pvec4Out, const Vector4 *pvec4Src )
{
...
void VecMatQuat::QuaternionMultiply( Vector4 *pvec4Out, const Vector4 *pvec4Src1, const Vector4 *pvec4Src2 )
{
	float	px, py, pz, pw;
	float	qx, qy, qz, qw;
...
void VecMatQuat::QuaternionSlerp( Vector4 *pvec4Out, const Vector4 *pvec4Src1, const Vector4 *pvec4Src2, float fLerpValue )
{
#if	0
	// Slerp
...
void VecMatQuat::QuaternionToMatrix( Matrix matOut, const Vector4 *pvec4Quat )
{
...
void VecMatQuat::QuaternionToEuler( Vector3 *pvecAngle, const Vector4 *pvec4Quat )
{
	// XYZ軸回転の取得
	// Y回転を求める
