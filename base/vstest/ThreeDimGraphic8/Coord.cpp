...
Coord::Coord(LPDIRECT3DDEVICE9 pDev) : pDevice(pDev), numAxis(3), numNet(21) {
	...
	axis[0].position = D3DXVECTOR3(0, 0, 0); axis[0].color = D3DCOLOR_ARGB(255, 255, 0, 0);
	axis[1].position = D3DXVECTOR3(5, 0, 0); axis[1].color = D3DCOLOR_ARGB(255, 255, 0, 0);
	axis[2].position = D3DXVECTOR3(0, 0, 0); axis[2].color = D3DCOLOR_ARGB(255, 0, 255, 0);
	axis[3].position = D3DXVECTOR3(0, 5, 0); axis[3].color = D3DCOLOR_ARGB(255, 0, 255, 0);
	axis[4].position = D3DXVECTOR3(0, 0, 0); axis[4].color = D3DCOLOR_ARGB(255, 0, 0, 255);
	axis[5].position = D3DXVECTOR3(0, 0, -5); axis[5].color = D3DCOLOR_ARGB(255, 0, 0, 255);
