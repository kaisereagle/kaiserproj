=====================================================================
  ...
  Copyright (C) 2009-2011  Ru--en
    ...
    サイト: http://ru11en.wordpress.com/
    連絡先: ru-en@live.jp


  本プログラムは、PY 様の「ARTK_MMD v0.7」を元にしています。
  「ARTK_MMD」 http://ppyy.if.land.to/artk_mmd.html
...
●ソースコード
    本プログラムのソースコードは http://ru11en.wordpress.com/ にて入手可能です。

    元となっている「ARTK_MMD」は http://ppyy.if.land.to/ にて公開されています。
    利用している「Bullet」は http://www.bulletphysics.com/ にて公開されています。

    本プログラムの開発には Microsoft Visual C++ 2008 SP1 を使用しました。


●更新履歴
    2011/04/30 Ver.0.5.1    PNG,JPEG等のテクスチャをGDI+で読み込むようにした
    2011/03/27 Ver.0.5.0    エッジ指定無し材質の色計算を修正（主にLat式対策）
