...
void main( void )
{
	...
	// ライトの向きの逆ベクトルを接地空間に変換
		...
		vLight0DirGen.x = dot( lViewTan, -lLightDir ) ;
		vLight0DirGen.y = dot( lViewBin, -lLightDir ) ;
		vLight0DirGen.z = dot( lViewNrm, -lLightDir ) ;
...
// ライト0の処理 ***********************************************************************************************************************************( 終了 )
	...
	// ライトの向きの逆ベクトルを接地空間に変換
		...
		vLight1DirGen.x = dot( lViewTan, -lLightDir ) ;
		vLight1DirGen.y = dot( lViewBin, -lLightDir ) ;
		vLight1DirGen.z = dot( lViewNrm, -lLightDir ) ;
...
// ライト1の処理 ***********************************************************************************************************************************( 終了 )
	...
	// ライトの向きの逆ベクトルを接地空間に変換
		...
		vLight2DirGen.x = dot( lViewTan, -lLightDir ) ;
		vLight2DirGen.y = dot( lViewBin, -lLightDir ) ;
		vLight2DirGen.z = dot( lViewNrm, -lLightDir ) ;
