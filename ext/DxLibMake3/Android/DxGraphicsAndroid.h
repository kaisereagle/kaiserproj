...
#ifndef __DXGRAPHICSANDROID_H__
#define __DXGRAPHICSANDROID_H__
...
#define ANDROID_GL_EXTENSION_NUM							(12)
...
#define ANDROID_SHADER_UNIFORM_SHADOWMAP_LIGHT_ENABLE			(41)		// シャドウマップ０・１・２のライト有効情報( x:シャドウマップ０でライトnが有効か  y:シャドウマップ１でライトnが有効か  z:シャドウマップ２でライトnが有効か )
#define ANDROID_SHADER_UNIFORM_SHADOWMAP_DADJ_GRAD				(42)		// シャドウマップの情報( x:閾値深度補正値  y:グラデーション範囲  )
#define ANDROID_SHADER_UNIFORM_NUM								(43)
...
struct GRAPHICS_HARDWARE_ANDROID_SHADER_BASE3D
{
	...
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// [ フラグメントシェーダーのアルファテストモード ]
	GLuint		Base3D_PixelLighting_Normal_FS[ 2 ][ 84 ][ ANDROID_RENDER_TYPE_NUM ][ 2 ][ 2 ][ ANDROID_FS_ALPHATEST_NUM ] ;
	...
	// フラグメントシェーダー[ テクスチャRGB無視( 0:無視しない  1:無視する ) ]
	// フラグメントシェーダー[ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// フラグメントシェーダー[ フラグメントシェーダーのアルファテストモード ]
	GRAPHICS_ANDROID_SHADER		*Base3D_PixelLighting_Normal_Shader[ 2 ][ 4 ][ 84 ][ ANDROID_RENDER_TYPE_NUM ][ 2 ][ 2 ][ ANDROID_FS_ALPHATEST_NUM ] ;
	...
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// [ フラグメントシェーダーのアルファテストモード ]
	GLuint		Base3D_ShadowMap_Normal_FS[ 2 ][ ANDROID_FS_ALPHATEST_NUM ] ;

	// 標準３Ｄ描画用のシャドウマップへのレンダリング用シェーダー
	// 頂点シェーダー[ バンプマップの有無( 0:無し 1:有り ) ]
	// フラグメントシェーダー[ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// フラグメントシェーダー[ フラグメントシェーダーのアルファテストモード ]
	GRAPHICS_ANDROID_SHADER		*Base3D_ShadowMap_Normal_Shader[ 2 ][ 2 ][ ANDROID_FS_ALPHATEST_NUM ] ;
	...
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// [ フラグメントシェーダーのアルファテストモード ]
	GLuint		Base3D_NoLighting_Normal_FS[ ANDROID_RENDER_TYPE_NUM ][ 2 ][ 2 ][ ANDROID_FS_ALPHATEST_NUM ] ;
	...
	// フラグメントシェーダー[ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// フラグメントシェーダー[ フラグメントシェーダーのアルファテストモード ]
	GRAPHICS_ANDROID_SHADER		*Base3D_NoLighting_Normal_Shader[ 4 ][ ANDROID_RENDER_TYPE_NUM ][ 2 ][ 2 ][ ANDROID_FS_ALPHATEST_NUM ] ;
	...
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// [ フラグメントシェーダーのアルファテストモード ]
	GLuint		Base3D_VertexLighting_Normal_FS[ 2 ][ 10 ][ ANDROID_RENDER_TYPE_NUM ][ 2 ][ 2 ][ ANDROID_FS_ALPHATEST_NUM ] ;
	...
	// フラグメントシェーダー[ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// フラグメントシェーダー[ フラグメントシェーダーのアルファテストモード ]
	GRAPHICS_ANDROID_SHADER		*Base3D_VertexLighting_Normal_Shader[ 2 ][ 4 ][ 20 ][ 10 ][ ANDROID_RENDER_TYPE_NUM ][ 2 ][ 2 ][ ANDROID_FS_ALPHATEST_NUM ] ;
} ;
...
struct GRAPHICS_HARDWARE_ANDROID_SHADERCODE_BASE3D
{
	...
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// [ フラグメントシェーダーのアルファテストモード ]
	GRAPHICS_HARDWARE_ANDROID_SHADERCODE_INFO Base3D_PixelLighting_Normal_FS_Code[ 2 ]/*[ 5 ]*//*[ 2 ]*//*[ 2 ]*/[ 84 ]/*[ 2 ]*/[ ANDROID_RENDER_TYPE_NUM ][ 2 ][ 2 ][ ANDROID_FS_ALPHATEST_NUM ] ;
	...
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// [ フラグメントシェーダーのアルファテストモード ]
	GRAPHICS_HARDWARE_ANDROID_SHADERCODE_INFO Base3D_ShadowMap_Normal_FS_Code[ 2 ][ ANDROID_FS_ALPHATEST_NUM ] ;
	...
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// [ フラグメントシェーダーのアルファテストモード ]
	GRAPHICS_HARDWARE_ANDROID_SHADERCODE_INFO Base3D_NoLighting_Normal_FS_Code/*[ 5 ]*/[ ANDROID_RENDER_TYPE_NUM ][ 2 ][ 2 ][ ANDROID_FS_ALPHATEST_NUM ] ;
	...
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// [ フラグメントシェーダーのアルファテストモード ]
	GRAPHICS_HARDWARE_ANDROID_SHADERCODE_INFO Base3D_VertexLighting_Normal_FS_Code[ 2 ]/*[ 5 ]*//*[ 2 ]*//*[ 2 ]*/[ 10 ]/*[ 2 ]*/[ ANDROID_RENDER_TYPE_NUM ][ 2 ][ 2 ][ ANDROID_FS_ALPHATEST_NUM ] ;
} ;
...
extern	int		Graphics_Android_DeviceState_SetBackgroundColor( int Red, int Green, int Blue ) ;					// 背景色を設定する
...
extern	int		Graphics_Android_DeviceState_SetBlendMode( int BlendMode ) ;											// 描画ブレンドモードのセット
...
extern	int		Graphics_Android_DrawSetting_SetIgnoreDrawGraphColor( int EnableFlag ) ;							// 描画時の画像の色を無視するかどうかを設定する
