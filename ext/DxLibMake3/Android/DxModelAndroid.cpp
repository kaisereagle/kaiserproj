...
//	}
	...
	case DX_BLENDMODE_ALPHA :
		...
		{
			Graphics_Android_DeviceState_SetBlendMode( DX_BLENDMODE_PMA_ALPHA ) ;
		}
		else
		{
			Graphics_Android_DeviceState_SetBlendMode( DX_BLENDMODE_ALPHA ) ;
		}
		break ;
	...
	case DX_BLENDMODE_ADD :
		if( Frame->Container->UseDrawMulAlphaColor )
		{
			Graphics_Android_DeviceState_SetBlendMode( DX_BLENDMODE_PMA_ADD ) ;
		}
		else
		{
			Graphics_Android_DeviceState_SetBlendMode( DX_BLENDMODE_ADD ) ;
		}
		break ;
	}
