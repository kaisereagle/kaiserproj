...
{
	ConvString( ( const char * )L"", ANDROID_WCHAR_CHARCODEFORMAT, Buffer, BufferBytes, CHAR_CHARCODEFORMAT ) ;
...
{
	ConvString( ( const char * )L"", ANDROID_WCHAR_CHARCODEFORMAT, ( char * )Buffer, BufferBytes, WCHAR_T_CHARCODEFORMAT ) ;
...
extern int _CHDIR( const char *DirName )
{
	...
	ConvString( DirName, CHAR_CHARCODEFORMAT, ( char * )TempBuffer, sizeof( TempBuffer ), ANDROID_WCHAR_CHARCODEFORMAT ) ;
