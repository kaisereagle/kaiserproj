...
#if 1
#	define VSHFILENAME	"..\\shader\\taurus.vs"
#	define FSHFILENAME	"..\\shader\\taurus.fs"
#else
#	define VSHFILENAME	"..\\shader\\fscolor1.vs"
#	define FSHFILENAME	"..\\shader\\fscolor1.fs"
#endif
...
int Initialize(int width, int height)
{
	...
	glLoadIdentity();
	gluPerspective(40.0f, aspect, 2.0f, 6.0f);
